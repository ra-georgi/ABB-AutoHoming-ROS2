...
def generate_launch_description():
    ...
    # update_joints_urdf = IncludeLaunchDescription(
    #             PythonLaunchDescriptionSource([
    #                 FindPackageShare("yumi_main_autohoming"), '/launch', '/yumi_socket_launch.py'])
    #         )


    set_joint_values = Node(
        package="yumi_main_autohoming",
        executable="set_yumi_joints",
        output="screen",
    )
